...
public class DigitalAsset {
	...
	public WebElement generalDropdown_second() {
		return generalDropdown_First().getShadowRoot()
				.findElement(By.cssSelector("#operators"));
	}
	...
	public WebElement RelationshipMaindropdown_Obj() {
		return generalDropdown_First().getShadowRoot()
				.findElement(By.cssSelector("#relationshipButton")).getShadowRoot()
	...
	public WebElement HasImagesDropdownvalue() {
		return generalDropdown_First().getShadowRoot()
				.findElement(By.cssSelector("#relationshipModelLov")).getShadowRoot()
				...
				.findElement(By.cssSelector("#lit-grid")).findElement(By.cssSelector("[ref='centerContainer'] > [ref='eViewport'] > [ref='eContainer']")).findElement(By.cssSelector("[row-index='1']"));
	}
	...
	// .findElement(By.cssSelector("#entityGrid")).getShadowRoot()
	// .findElement(By.cssSelector("#gridHeader > div.grid-actions.row >
	// span.text-ellipsis.m-r-5.m-l-5.page-range"));
	// }
	...
	// return common_element().getShadowRoot()
	// .findElement(By.cssSelector("#rockTabs")).getShadowRoot()
	// .findElement(By.cssSelector("#tab-review2dlinedrawingbc_businessCondition
	// > div > div.tab-title > span.dynamic-close"));
	// }
...
//	// return
//	// common_element().getShadowRoot()
//				.findElement(By.cssSelector("#rockTabs")).getShadowRoot()
//	// .findElement(By.cssSelector("#tab-summary > div > div.tab-title >
//	// span"));
//	// }
	...
	public WebElement ImageRequired_Yes() {
		return common_element().getShadowRoot()
				...
				.findElement(By.cssSelector("div.base-grid-structure.p-relative > div.base-grid-structure-child-2.overflow-auto.p-relative > pebble-grid")).getShadowRoot()
				.findElement(By.cssSelector("#grid")).getShadowRoot()
				.findElement(By.cssSelector("#lit-grid")).findElement(By.cssSelector("[ref='eRootWrapper']")).findElement(By.cssSelector("[ref='gridBody']")).findElement(By.cssSelector("[ref='eBodyViewport']")).findElement(By.cssSelector("[ref='centerContainer']")).findElement(By.cssSelector("[ref='eContainer']")).findElement(By.cssSelector("[row-index='1']"));
	}
	...
	public WebElement ImageRequired_No() {
		return common_element().getShadowRoot()
				...
				.findElement(By.cssSelector("div.base-grid-structure.p-relative > div.base-grid-structure-child-2.overflow-auto.p-relative > pebble-grid")).getShadowRoot()
				.findElement(By.cssSelector("#grid")).getShadowRoot()
				.findElement(By.cssSelector("#lit-grid")).findElement(By.cssSelector("[ref='eRootWrapper']")).findElement(By.cssSelector("[ref='gridBody']")).findElement(By.cssSelector("[ref='eBodyViewport']")).findElement(By.cssSelector("[ref='centerContainer']")).findElement(By.cssSelector("[ref='eContainer']")).findElement(By.cssSelector("[row-index='0']"));
	}
	...
	public WebElement Status_InProgress_dropdownvalue() {
		return driver.findElement(By.cssSelector("#app")).getShadowRoot()
				...
				.findElement(By.cssSelector("div.base-grid-structure.p-relative > div.base-grid-structure-child-2.overflow-auto.p-relative > pebble-grid")).getShadowRoot()
				.findElement(By.cssSelector("#grid")).getShadowRoot()
				.findElement(By.cssSelector("#lit-grid > div > div.ag-root-wrapper-body.ag-layout-normal.ag-focus-managed > div.ag-root.ag-unselectable.ag-layout-normal > div.ag-body-viewport.ag-layout-normal.ag-row-no-animation > div.ag-center-cols-clipper > div > div > div:nth-child(3) > div > pebble-lov-item")).getShadowRoot()
				.findElement(By.cssSelector("div > div > div > span.has-only-option"));
	}
	public WebElement Status_Approved_dropdownvalue() {
		return driver.findElement(By.cssSelector("#app")).getShadowRoot()
				...
				.findElement(By.cssSelector("div.base-grid-structure.p-relative > div.base-grid-structure-child-2.overflow-auto.p-relative > pebble-grid")).getShadowRoot()
				.findElement(By.cssSelector("#grid")).getShadowRoot()
				.findElement(By.cssSelector("#lit-grid > div > div.ag-root-wrapper-body.ag-layout-normal.ag-focus-managed > div.ag-root.ag-unselectable.ag-layout-normal > div.ag-body-viewport.ag-layout-normal.ag-row-no-animation > div.ag-center-cols-clipper > div > div > div:nth-child(2) > div > pebble-lov-item")).getShadowRoot()
				.findElement(By.cssSelector("div > div > div > span.has-only-option"));
	}
	...
	public WebElement Total_Checkboxes() {
		return ParentEle().getShadowRoot()
				...
				.findElement(By.cssSelector("div.base-grid-structure.p-relative > div.base-grid-structure-child-2.overflow-auto.p-relative > pebble-grid")).getShadowRoot()
				.findElement(By.cssSelector("#grid")).getShadowRoot()
				.findElement(By.cssSelector("#lit-grid")).findElement(By.cssSelector("[ref='gridBody']"));
	}
	...
	public WebElement summarybcs() {
		return common_element().getShadowRoot()
				...
				.findElement(By.cssSelector("#rock-entity-tofix")).getShadowRoot()
				.findElement(By.cssSelector("[id^='rock-entity-tofix-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector(".tofix-data-container > pebble-accordion")).findElement(By.cssSelector("[slot='accordion-content']"));
	}
	...
	public WebElement ClassifiedImages_Grid() {
		return common_element().getShadowRoot()
				...
				.findElement(By.cssSelector("#grid")).getShadowRoot()
				.findElement(By.cssSelector("#lit-grid > div > div.ag-root-wrapper-body.ag-layout-normal.ag-focus-managed > div.ag-root.ag-unselectable.ag-layout-normal > div.ag-body-viewport.ag-layout-normal.ag-row-no-animation > div.ag-center-cols-clipper > div"));
	}
	...
	public String getAssetAttributeValueBySearchLabel(SummaryPage summaryPage, String attributeSearchLabel, ExtentTest test) {
		...
		try {
			...
			if (value.isEmpty() && (attributeSearchLabel.equalsIgnoreCase("Asset Type") || attributeSearchLabel.equalsIgnoreCase("Asset Category"))) {
				try {
				...
				.findElement(By.cssSelector("bedrock-lov")).getShadowRoot()
				.findElement(By.cssSelector("#collectionContainer")).getShadowRoot()
				.findElement(By.cssSelector("#collection_container_wrapper > div.d-flex > div.tags-container")).getText().trim();
				} catch (Exception e) {
				}
			}
			...
			if (value.isEmpty() && attributeSearchLabel.equalsIgnoreCase("Asset Alternate Text")) {
				...
				.findElement(By.cssSelector(".attribute-control")).getAttribute("value").trim();
				} catch (Exception e) {
				}
			}
			// Image Height / Image Width / X Resolution / Y Resolution
			if (value.isEmpty() && (attributeSearchLabel.equalsIgnoreCase("Image Height") || attributeSearchLabel.equalsIgnoreCase("Image Width") || attributeSearchLabel.equalsIgnoreCase("X Resolution") || attributeSearchLabel.equalsIgnoreCase("Y Resolution"))) {
				try {
					value = ImageAttributes().getShadowRoot()
				.findElement(By.cssSelector("[id^='rock-attribute-manage-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector("#rock-attribute-list-container > rock-attribute-list")).getShadowRoot()
				.findElements(By.cssSelector("[id^='rs']")).get(1).getShadowRoot()
				.findElement(By.cssSelector("div > div > div.attribute-view.list > div > span")).getText().trim();
				} catch (Exception e) {
				}
			}
			...
			if (value.isEmpty() && attributeSearchLabel.equalsIgnoreCase("Original File Name Property")) {
				...
				.findElement(By.cssSelector("#rock-attribute-list-container > rock-attribute-list")).getShadowRoot()
				.findElement(By.cssSelector("[id^='rs']")).getShadowRoot()
				.findElement(By.cssSelector("div > div > .attribute-view-value")).getText().trim();
				} catch (Exception e) {
				}
			}
	...
	/***************************************************************************
	 * Page Object representing the Renditions attribute grid (Asset >
	 * Attributes tab > Renditions nested grid) and check for the rows appearing
	 ************************************************************************/
	public WebElement getRowContainer() {
		return driver.findElement(By.cssSelector("#app")).getShadowRoot()
				...
				.findElement(By.cssSelector("#pebbleGridContainer > pebble-grid")).getShadowRoot()
				.findElement(By.cssSelector("#grid")).getShadowRoot()
				.findElement(By.cssSelector("#lit-grid > div > div.ag-root-wrapper-body.ag-layout-auto-height.ag-focus-managed " + "> div.ag-root.ag-unselectable.ag-layout-auto-height " + "> div.ag-body-viewport.ag-layout-auto-height.ag-row-no-animation " + "> div.ag-center-cols-clipper > div"));
	}
	/***************************************************************************
	...
	/*****************************************************************
	 * Extracts the Rendition ID/title value from a given row. Reads the "title"
	 * attribute of the cell mapped to col-id="renditionid" (e.g.
	 * "white_background", "transparent_background").
	 * 
	 * @param row
	 *            the row WebElement (obtained via getRowByIndex or getRows)
	...
	// .findElement(By.cssSelector("#rockTabs")).getShadowRoot()
	// .findElement(By.cssSelector("[id^='rock-relationship-split-screen-component']")).getShadowRoot()
	// .findElement(By.cssSelector("#undefined-relationship-container >
	// rock-relationship-manage")).getShadowRoot()
	// .findElement(By.cssSelector("#entityRelationshipSearchResult_hasimages")).getShadowRoot()
	// .findElement(By.cssSelector("div > div.base-grid-structure-child-2 >
	// rock-relationship-grid")).getShadowRoot()
	// .findElement(By.cssSelector("#relationship_actions")).getShadowRoot()
	// .findElement(By.cssSelector("#actions")).getShadowRoot()
	// .findElement(By.cssSelector("#simpleButton"));
	// }
 ...
 *
 * @param searchPage       Search page object containing filter UI elements
 * @param filterName       Filter label to search and select (e.g., "Image Required? (Auto)")
 * @param dropdownSupplier Supplier for the filter dropdown element
 * @param optionText       LOV option text to select (e.g., "Has No Value")

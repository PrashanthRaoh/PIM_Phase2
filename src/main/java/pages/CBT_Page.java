...
public class CBT_Page {
	...
	public WebElement Override_Yes_Option() {
		return CBT_Override1().getShadowRoot().findElement(By.cssSelector("#input")).getShadowRoot()
				...
				.getShadowRoot().findElement(By.cssSelector("#grid")).getShadowRoot().findElement(By.cssSelector(
						"#lit-grid > div > div.ag-root-wrapper-body.ag-layout-normal.ag-focus-managed > div.ag-root.ag-unselectable.ag-layout-normal > div.ag-body-viewport.ag-layout-normal.ag-row-no-animation > div.ag-center-cols-clipper > div > div > [row-index='1']"));
	}
	...
	public WebElement CBT_Workflow_Refresh_btn() {
		return driver.findElement(By.cssSelector("#app")).getShadowRoot()
				...
				.findElement(By.cssSelector("#entityActions")).getShadowRoot().findElement(By.cssSelector("#toolbar"))
				.getShadowRoot().findElement(By.cssSelector("#refresh"));
	}
	...
	public WebElement MoreDetailsReviewUsecaseSelection() {
		return CBT_Usecasetab_Commonelements().getShadowRoot()
				.findElement(By.cssSelector("[id^='my-todo-summary-list-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector("pebble-list-view > pebble-list-item:nth-child(2) > my-todo-summary"))
				.getShadowRoot().findElement(By.cssSelector("#viewDetails > span[title='More details']"));
	}

	public WebElement UCOReviewSelectionDiscrepanciesCBT_Link() {
		return CBT_Usecasetab_Commonelements().getShadowRoot()
				.findElement(By.cssSelector("[id^='my-todo-summary-list-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector("pebble-list-view > pebble-list-item:nth-child(2) > my-todo-summary"))
				.getShadowRoot().findElement(By.cssSelector("#reviewusecasecatalogbearingtool_bc_businessCondition"))
				.getShadowRoot().findElement(By.cssSelector("#button-text-box"));
	}
	...
	public WebElement Tabclose_Xmark() {
		return driver.findElement(By.cssSelector("#app")).getShadowRoot()
				...
				.getShadowRoot()
				.findElement(By.cssSelector("#tab-QuickSearchAttributes > div > div.tab-title > span.dynamic-close"));
	}
	...
	public WebElement CBTIntFilterElement() {
	...
	public WebElement HasNoItemsOption() {
		return SameParent().getShadowRoot().findElement(By.cssSelector("#operators")).getShadowRoot()
				.findElement(By.cssSelector(
						"div.base-grid-structure.p-relative.hideLovHeader > div.base-grid-structure-child-2.overflow-auto.p-relative > pebble-grid"))
				.getShadowRoot().findElement(By.cssSelector("#grid")).getShadowRoot().findElement(By.cssSelector(
						"#lit-grid > div > div.ag-root-wrapper-body.ag-layout-normal.ag-focus-managed > div.ag-root.ag-unselectable.ag-layout-normal > div.ag-body-viewport.ag-layout-normal.ag-row-no-animation > div.ag-center-cols-clipper > div > div > div[row-index='3']"));
	}

	public WebElement UsecaseIntYesCheckbox() {
		return SameParent().getShadowRoot().findElement(By.cssSelector("#rockEntityLov")).getShadowRoot()
				...
				.findElement(By.cssSelector(
						"div.base-grid-structure.p-relative > div.base-grid-structure-child-2.overflow-auto.p-relative > pebble-grid"))
				.getShadowRoot().findElement(By.cssSelector("#grid")).getShadowRoot().findElement(By.cssSelector(
						"#lit-grid > div > div.ag-root-wrapper-body.ag-layout-normal.ag-focus-managed > div.ag-root.ag-unselectable.ag-layout-normal > div.ag-body-viewport.ag-layout-normal.ag-row-no-animation > div.ag-center-cols-clipper > div > div > div[row-index='1']"));
	}

	public List<WebElement> CatalogBearingToolUsecaseInt_Override_Dropdown() {
		List<WebElement> rsList = Common_Summary_items1().getShadowRoot().findElement(By.cssSelector("#rockTabs"))
	...
	public WebElement CBTUsecase_Int__Readonly() {
		return Common_Summary_items1().getShadowRoot().findElement(By.cssSelector("#rockTabs")).getShadowRoot()
				.findElement(By.cssSelector("[id^='rock-wizard-manage-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector("[id^='rock-attribute-split-screen-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector("#undefined-attribute-container > rock-attribute-manage")).getShadowRoot()
				...
				.findElement(
						By.cssSelector("#collection_container_wrapper > div.d-flex > div.tags-container > pebble-tags"))
				.getShadowRoot().findElement(By.cssSelector("#tag0"));
	}

	public WebElement CBT_Sellable_Product_Status() {
		return Common_Summary_items1().getShadowRoot().findElement(By.cssSelector("#rockTabs")).getShadowRoot()
				.findElement(By.cssSelector("[id^='rock-wizard-manage-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector("[id^='rock-attribute-manage-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector("#rock-attribute-list-container > rock-attribute-list")).getShadowRoot()
				.findElement(By.cssSelector(
						"div > div > div > pebble-accordion > [slot='accordion-content'] > div > [name='cbtsellableproductstatus'] > rock-attribute"))
				.getShadowRoot().findElement(By.cssSelector("div > div > .attribute-edit > #input")).getShadowRoot()
				.findElement(By.cssSelector("bedrock-lov")).getShadowRoot()
				.findElement(By.cssSelector("#collectionContainer")).getShadowRoot()
				.findElement(By.cssSelector("div > .d-flex > .tags-container > pebble-tags"));
	}

	public WebElement CBT_Hold_Attributes_list() {
		return Common_Summary_items1().getShadowRoot().findElement(By.cssSelector("#rockTabs")).getShadowRoot()
				.findElement(By.cssSelector("[id^='rock-wizard-manage-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector("[id^='rock-attribute-manage-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector("#rock-attribute-list-container > rock-attribute-list")).getShadowRoot()
				.findElement(By.cssSelector(
						"div > div > div > pebble-accordion > [slot='accordion-content'] > div > [name='cbtholdattributelistruletriggered'] > rock-attribute"))
				.getShadowRoot()
				.findElement(By.cssSelector("[class='attribute list  referencelist '] > div > div > #input"))
				.getShadowRoot().findElement(By.cssSelector("bedrock-lov")).getShadowRoot()
				.findElement(By.cssSelector("#collectionContainer")).getShadowRoot()
				.findElement(By.cssSelector("div > .d-flex > .tags-container > pebble-tags"));
	}

	public WebElement CBTUcasecaseInt_ThingDomain() {
		return SameParent().getShadowRoot()
				.findElement(By.cssSelector("#attributeModelLov_thing")).getShadowRoot()
				.findElement(By.cssSelector("#modelLov_thing"))
				.getShadowRoot().findElement(By.cssSelector("div.base-grid-structure.p-relative.hideLovHeader > div.base-grid-structure-child-2.overflow-auto.p-relative > pebble-grid")).getShadowRoot()
	...
	public WebElement CBTUcasecaseInt_Yes_Option() {
		return SameParent().getShadowRoot().findElement(By.cssSelector("#rockEntityLov")).getShadowRoot()
				.findElement(By.cssSelector("#entityLov")).getShadowRoot()
	...
	public WebElement CBTSellableProd_Status_Thingdomain() {
	    return SameParent().getShadowRoot()
	        .findElement(By.cssSelector("#attributeModelLov_thing")).getShadowRoot()

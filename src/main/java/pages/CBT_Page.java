...
public class CBT_Page {
	...
	public WebElement HasNoItemsOption() {
		return SameParent().getShadowRoot()
			    ...
			    .findElement(By.cssSelector("#grid")).getShadowRoot()
			    .findElement(By.cssSelector("#lit-grid > div > div.ag-root-wrapper-body.ag-layout-normal.ag-focus-managed > div.ag-root.ag-unselectable.ag-layout-normal > div.ag-body-viewport.ag-layout-normal.ag-row-no-animation > div.ag-center-cols-clipper > div > div > div[row-index='3']"));
	}
	...
	public WebElement UsecaseIntYesCheckbox() {
		return SameParent().getShadowRoot()
			    ...
			    .findElement(By.cssSelector("#grid")).getShadowRoot()
			    .findElement(By.cssSelector("#lit-grid > div > div.ag-root-wrapper-body.ag-layout-normal.ag-focus-managed > div.ag-root.ag-unselectable.ag-layout-normal > div.ag-body-viewport.ag-layout-normal.ag-row-no-animation > div.ag-center-cols-clipper > div > div > div[row-index='1']"));
	}
	
	public List<WebElement> CatalogBearingToolUsecaseInt_Override_Dropdown() {
		  List<WebElement> rsList = Common_Summary_items1()
			    .getShadowRoot().findElement(By.cssSelector("#rockTabs"))
			    ...
			    ).getShadowRoot().findElements(By.cssSelector("[id^='rs']"));
		 return rsList;
	}
	
	public WebElement CBTUsecase_Int__Readonly() {
		return Common_Summary_items1()
	    .getShadowRoot().findElement(By.cssSelector("#rockTabs"))
	    .getShadowRoot().findElement(By.cssSelector("[id^='rock-wizard-manage-component-rs']"))
	    .getShadowRoot().findElement(By.cssSelector("[id^='rock-attribute-split-screen-component-rs']"))
	    .getShadowRoot().findElement(By.cssSelector("#undefined-attribute-container > rock-attribute-manage"))
	...
	public WebElement CBT_Sellable_Product_Status() {
		return Common_Summary_items1().getShadowRoot().findElement(By.cssSelector("#rockTabs")).getShadowRoot()
				...
				.findElement(By.cssSelector("[id^='rock-attribute-manage-component-rs']")).getShadowRoot()
				.findElement(By.cssSelector("#rock-attribute-list-container > rock-attribute-list")).getShadowRoot()
				.findElement(By.cssSelector("div > div > div > pebble-accordion > [slot='accordion-content'] > div > [name='cbtsellableproductstatus'] > rock-attribute")).getShadowRoot()

...
// ****************************************************************************/
//
//public class TC_001_Munitions_Indicator2 extends BaseTest {
//
//    ExtentTest test;
//    Utils utils;
//    HomePage homePage;
...
//    // Initialize utils
//    
//    @DataProvider(name = "munitionIndicatorData")
//    public Object[][] munitionIndicatorData() {
//        return new Object[][] {
//            {"Yes"},
//            {"No"}
//        };
//    }
//
//    @Test(dataProvider = "munitionIndicatorData", groups = { "BSAPIEowner" })
//    public void MunitionsIndicator_Verification(String indicator) throws Exception {
//        // Initialize page objects
//    	String className = this.getClass().getSimpleName();
//    	System.out.println("Executing Test  ---  " + className);
//        test = BaseTest.extentreport.createTest("Munitions Indicator Test - " + indicator);
...
//        test.pass("Home Page displayed", MediaEntityBuilder.createScreenCaptureFromPath(Utils.Takescreenshot(driver)).build());
//
//        homePage.clickSearch_Products_Button().click();
//        utils.waitForElement(() -> searchPage.getgrid(), "clickable");
//        test.pass("Search products clicked", MediaEntityBuilder.createScreenCaptureFromPath(Utils.Takescreenshot(driver)).build());
//
//        searchPage.getFilterButton().click();
//        Thread.sleep(3000);
//        utils.waitForElement(() -> searchPage.Search_MaterialType(), "clickable");
//        
//        String rowText = "BSA PIE Usecase?"; 
//        searchPage.Search_MaterialType().sendKeys(rowText); 
//        test.pass("Entered BSA PIE Usecase? in the search bar ");
...
//        		.findElement(By.cssSelector("#grid")).getShadowRoot() .findElement(By.cssSelector("#lit-grid>div"))
...
//        usecase.click(); 
//        Thread.sleep(2000); 
//        test.pass("BSA PIE Usecase? filter selected");
//        test.log(Status.PASS, MediaEntityBuilder.createScreenCaptureFromPath(Utils.Takescreenshot(driver)).build()); 
//        
//        utils.waitForElement(() -> BSAPIE_PO.BSAUseCase_YES_Checkbox(), "clickable"); 
//        Thread.sleep(2000);
//        test.pass("BSA PIE Usecase? YES option selected");
//        test.log(Status.PASS, MediaEntityBuilder.createScreenCaptureFromPath(Utils.Takescreenshot(driver)).build());
//        BSAPIE_PO.BSAUseCase_YES_Checkbox().click();
//        digitalssetPage.Status_Apply_btn().click(); 
//        test.pass("Confirmed by clicking on Apply button"); 
//        test.log(Status.PASS, MediaEntityBuilder.createScreenCaptureFromPath(Utils.Takescreenshot(driver)).build()); 
//        Thread.sleep(1000);
//        
//        // Click filter and search for Munition Indicator
//        verifyMunitionIndicator(indicator);
//    }
//
//	/************************************************
//	 * - Reusable Method --
...
//        test.pass("Entered Munitions Indicator in the search bar",MediaEntityBuilder.createScreenCaptureFromPath(Utils.Takescreenshot(driver)).build());
//
...
//            test.fail(result + " rows appeared which is NOT expected",MediaEntityBuilder.createScreenCaptureFromPath(Utils.Takescreenshot(driver)).build());
//        } catch (Exception e) {

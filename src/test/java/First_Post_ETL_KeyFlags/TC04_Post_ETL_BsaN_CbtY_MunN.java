...
/*****************************************************************************************
 ...
 Catalog Bearing Tool Sellable Product Status = Approved
 ****************************************************************************************/
public class TC04_Post_ETL_BsaN_CbtY_MunN extends BaseTest{
...
//		utils.waitForElement(() -> homePage.BSAPIEUsecaseApprovalTab(), "visible");
		...
		String POST_ETL_Filename = "/Post_ETL_Artifacts/Key_Flags/TC04_BsaN_CbtY_MunN.txt";
		...
		if ("Approved".equalsIgnoreCase(CBT_Status == null ? "" : CBT_Status.trim())) {
			...
			test.fail("Catalog Bearing Tool Sellable Product Status expected was Approved.But Actual status is : " + CBT_Status);
		}
//		Assert.assertEquals(CBT_Status == null ? "" : CBT_Status.trim(), "Approved", "Expected Catalog Bearing Tool Sellable Product Status to be Approved, but got: " + CBT_Status);
